...
We first examined the boxplot for VitC and found the difference in average between c39 and c52. We found out that there are statistically different. We then examined the numerical results in which we found the numerical values of c39 and c52. Finally, we wrote the hypothesis in inferential results in which we rejected the null hypothesis because the chances are exteremely low. Making c39 and c52 significantly different. 
